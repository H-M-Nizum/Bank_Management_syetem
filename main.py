    ...
    if n==1:
        ...
        while flag1:
            ...
            if a == 1:
                ...
                while account_id in Bank_account:
                    account_id = input('This is invalid, try again: ')
                Bank_account[account_id] = acc
                while flag2:
                    print('\n1. Deposit money \n2. Withdraw money')
                    ...
                    if b == 1:
                        ...
                        if tranfer_id in Bank_account:
                            acc.transfer(money, Bank_account[tranfer_id])
                        else:
                ...
                if passward in Bank_account:
                    flag2 = True
                    while flag2:
                        acc = Bank_account[passward]
                        print('\n1. Deposit money \n2. Withdraw money')
                        print('3. Check balance \n4. Transaction \n5. Check Transaction history')
                        print('6. If  your need loan')
                        print('press any key if you want back')
            ...
            while flag1:
                ...
                if n == 1:
                    ...
                    for key in Bank_account:
                        print(Bank_account[key].deatils())
